...
#   CTL_CAPNP(CAPNP_SRCS CAPNP_HDRS schema.capnp)
...
#       (CAPNPC_SRC_PREFIX and CTL_CAPNP_INCLUDE_DIRECTORY are always included.)
#   CAPNPC_SRC_PREFIX
...
function(CTL_CAPNP SOURCES HEADERS)

  if(NOT ARGN)
    message(SEND_ERROR "CTL_CAPNP() called without any source files.")
  endif()
  ...
  if(TARGET CapnProto::capnp_tool)
    ...
    if(NOT CTL_CAPNP_INCLUDE_DIRECTORY)
      ...
      #get_target_property(CTL_CAPNP_INCLUDE_DIRECTORY capnp_tool CTL_CAPNP_INCLUDE_DIRECTORY)
    endif()

    list(APPEND tool_depends CapnProto::capnp_tool CapnProto::capnpc_cpp)
  endif()
  ...
  if(NOT CTL_CAPNP_INCLUDE_DIRECTORY)
    message(SEND_ERROR "Could not locate capnp header files (CTL_CAPNP_INCLUDE_DIRECTORY).")
  endif()
  ...
  # Default compiler includes. Note that in capnp's own test usage of CTL_CAPNP(), these
  # two variables will end up evaluating to the same directory. However, it's difficult to
  # deduplicate them because if CTL_CAPNP_INCLUDE_DIRECTORY came from the capnp_tool target property,
  ...
  # worth fixing.
  set(include_path -I "${CAPNPC_SRC_PREFIX}" -I "${CTL_CAPNP_INCLUDE_DIRECTORY}")
